...
const CandidateFavorite = React.lazy(() => import("../pages/private/Candidate/CandidateFavorite"));
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: ROUTER.CANDIDATE_FAVORITE_JOBS,
            element: (
              <LazyLoad>
                <CandidateFavorite />
              </LazyLoad>
            ),
            handle: ROUTE_META[ROUTER.CANDIDATE_FAVORITE_JOBS],
          },
          {
